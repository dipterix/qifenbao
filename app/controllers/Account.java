...
public class Account extends Controller {
	...
	public static Result editProfile(){
		...
		return ok(profile_change.render(null, localUser));
	}
...
//		final User target = User.find.where().eq("id", f.get("id")).findUnique();
//		if(target == null){
//			return redirect(routes.Application.index());
//		}
//		if(localUser.hasPermission(Application.USER_PERMISSION_ADMIN)){
//			String permissions = f.get("permissions");
//			String sections = f.get("sections");
//			if(permissions != null){
//				target.togglePermission(permissions.split(","));
//			}
//			if(sections != null){
//				target.toggleSection(sections.split(","));
//			}
//			res = ok(profile_change.render(localUser, target));
//		}
//		if(localUser.hasPermission(Application.USER_PERMISSION_SECTION_MANAGER)){
//			String subsections = f.get("subSections");
//			if(subsections != null){
//				for(Section sect:localUser.editSections){
//					sect.tags.addAll(Tag.add(subsections.split(",")));
//					sect.save();
//				}
//			}
//		}
